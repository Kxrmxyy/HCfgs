...
_G["Use Webhook"] = {
    Enable = true,
    Webhook = "https://discord.com/api/webhooks/1202439106072813639/Pbh8Rk0-d-uG9ICOstkZOQ_b556by3k98QzfRRiqiQ-woUtDVslAoEKnWfWCzIIUCVyE",
}
_G.SupperFixLag = true

_G["Farm Sea Events When AllDone"] = {
    Enable = false, -- enable it or not
